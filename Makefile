...
SOURCES=src/controller/regions.cpp src/ui/renderable.cpp src/ui/shapes/shapes.cpp src/ui/menu/menu.cpp src/ui/button/button.cpp src/ui/window/window.cpp libs/multimedia/multimedia.cpp src/main.cpp

EXECUTABLE=phshop

SFML_EXEC= -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio
 
all: compile_debug run
