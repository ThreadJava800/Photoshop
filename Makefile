...
SOURCES=src/ui/renderable.cpp src/events/events.cpp src/ui/submenu/submenu.cpp src/ui/canvas/canvas.cpp src/ui/shapes/shapes.cpp src/ui/menu/menu.cpp src/ui/button/button.cpp src/ui/window/window.cpp libs/multimedia/multimedia.cpp src/main.cpp
