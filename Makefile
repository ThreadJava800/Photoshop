...
CFLAGS  = -g -D _DEBUG -ggdb3 -std=c++17 -O2 -w -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat -Wmissing-declarations \
...
SOURCES=src/ui/renderable.cpp src/ui/button/scrollbar.cpp src/ui/editbox/editbox.cpp src/ui/canvas/filters.cpp src/events/events.cpp src/ui/submenu/submenu.cpp src/ui/canvas/canvas.cpp src/ui/shapes/shapes.cpp src/ui/menu/menu.cpp src/ui/button/button.cpp src/ui/window/window.cpp libs/multimedia/multimedia.cpp src/main.cpp
