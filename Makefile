...
CFLAGS  = -D _DEBUG -ggdb3 -std=c++17 -O0 -w -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat -Wmissing-declarations \
...
compile_release:
	@${CC} -Wl,--export-dynamic -g -fPIE $(SOURCES) -O3 -o $(EXECUTABLE) $(SFML_EXEC) -ldl
